...
| KTVS-029 | 队列领域规则 | KTVS-027,028 | In Progress | 点歌、限额、删除、置顶、稳定排序和并发测试 | 无 |
| KTVS-030 | 队列与播放器编排 | KTVS-022,025,029 | Todo | 准备、播放、完成、失败、恢复和自动下一首 | 真实设备后验收 |
| KTVS-031 | REST API 与 OpenAPI | KTVS-018,019,027,028,029,030 | Todo | 统一错误、验证、分页和无路径契约 | 无 |
| KTVS-032 | SignalR 完整快照与增量事件 | KTVS-030,031 | Todo | 版本化快照、增量事件和重连恢复 | 手机实机后验收 |
