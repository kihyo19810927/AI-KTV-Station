...
export function QueuePage() {
  ...
  async function insert(item: QueueEntry) { try { setError(''); updateQueueItem(await api.post<QueueEntry>(`/api/queue/${item.id}/insert`, {})) } catch (value) { setError(value instanceof ApiError ? value.message : '无法插播这首歌曲。') } }
